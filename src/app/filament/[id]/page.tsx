                                ...
                                <CardContent>
                                    <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                                        <div className="flex items-center gap-3">
                                            <Image src="/images/nozzle_temp.svg" alt="Nozzle Temperature" width={24} height={24} />
                                            <div>
                                        ...
                                        <div className="flex items-center gap-3">
                                            <Image src="/images/bed_temp.svg" alt="Bed Temperature" width={24} height={24} />
                                            <div>
                                        ...
                                        <div className="flex items-center gap-3">
                                            <Image src="/images/flow_ratio_and_pressure_advance.svg" alt="Flow Ratio and Pressure Advance" width={24} height={24} />
                                            <div>
                                        ...
                                        <div className="flex items-center gap-3">
                                            <Image src="/images/retraction.svg" alt="Retraction Distance" width={24} height={24} />
                                            <div>
                                        ...
                                        <div className="flex items-center gap-3">
                                            <Image src="/images/volumetric_speed.svg" alt="Max Volumetric Speed" width={24} height={24} />
                                            <div>
